    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f4f6f5] via-white to-[#fdf8f6] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Sign in to continue tracking your little one</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 text-center">
            <Link href="/signup" className="text-sm text-[#425a51] hover:underline font-medium">
