...
const HeroSection = () => {
  return (
    <div className="bg-secondary-400 h-hero_height_sm md:h-hero_height_lg w-full">
      <div className='fixed inset-0 flex justify-start items-end w-full'>
            <Image src={BgImage} alt="bobo-bg" className='object cover h-full w-1000'/>
      </div>

      <div className="mt-32 mr-28 justify-end flex w-full bg-gradient-to-t from-white via-white lg:static lg:h-auto lg:w-auto lg:bg-none gap-4">
        <Link href="/signup">
      ...
      <div className="mt-10 md:mt-20 absolute text-secondary-500 w-full">
        ...
        <div className="md:hidden font-bold h-header_height_lg w-full text-center text-2xl xsm:text-4xl md:text-6xl flex flex-col">
          <span className="bg-gradient-to-r from-pink-300 to-black bg-clip-text text-transparent" >Made for Parents.</span>
          <span className="bg-gradient-to-r from-pink-300 to-black bg-clip-text text-transparent" >Built for Babies.</span>
        </div>

        <div className="flex flex-col font-semibold text-center text-xl xsm:text-base">
